...
> 原文:[https://www . geesforgeks . org/error _ messages-django-form-field-validation/](https://www.geeksforgeeks.org/error_messages-django-form-field-validation/)
...
## 姜戈表单域验证`error_messages`解释

使用示例说明错误消息。考虑一个名为`geeksforgeeks`的项目，它有一个名为`geeks`的应用程序。
...
![error_messages - Django Form Field Validation](img/16f66022094061282b4be5499ba296e5.png)

现在让我们试着提交它为空，并检查是否需要`error_message`已被覆盖。

![error_messages-Django-Form-Field-Validation](img/85d79a36267e5f30efa0884b1dfadc82.png)

因此，该字段显示 Charfield 的`required`属性的自定义错误消息。
