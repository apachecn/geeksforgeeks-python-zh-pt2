...
> 原文:[https://www . geesforgeks . org/help _ text-django-form-field-validation/](https://www.geeksforgeeks.org/help_text-django-form-field-validation/)
...
`help_text`参数允许您为此字段指定描述性文本。如果提供 help_text，当字段通过方便的表单方法之一呈现时，它将显示在字段旁边。字段的默认帮助文本为空。让我们检查如何在使用项目的字段中使用 help_text。
...
## 姜戈表单域验证`help_text`解释

使用示例说明帮助文本。考虑一个名为`geeksforgeeks`的项目，它有一个名为`geeks`的应用程序。
...
![help_text-Django-Form-Field-Validation](img/9047a1c035839821ad2c5d22b29312ca.png)
这样，一个 `geeks_field` **字符域**就在帮助文本“输入你的名字”下创建了。
