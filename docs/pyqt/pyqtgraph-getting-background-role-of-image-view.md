...
> 原文:[https://www . geesforgeks . org/pyqtgraph-get-background-role-of-image-view/](https://www.geeksforgeeks.org/pyqtgraph-getting-background-role-of-image-view/)
...
为此，我们对图像视图对象使用 **backgroundRole()** 方法

> **语法:** imv.backgroundRole()
> **参数:**它不需要参数
> **返回:**它返回 QPalette Object，但是打印时它显示与之相关的值
...
        # getting background role of image view
        value = imv.backgroundRole()
...
![](img/68afbf4115ee215916d599c7199a9192.png)