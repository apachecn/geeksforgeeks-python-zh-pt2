# PyQtGraph–获取线图中的线的名称

> 原文:[https://www . geesforgeks . org/pyqtgraph-get-line-name-in-line-graph/](https://www.geeksforgeeks.org/pyqtgraph-getting-name-of-line-in-line-graph/)

在本文中，我们将看到如何在 PyQtGraph 模块中获得线图的名称。PyQtGraph 是 Python 的图形和用户界面库，提供设计和科学应用程序通常需要的功能。它的主要目标是为显示数据(图表、视频等)提供快速的交互式图形。)折线图、线图、线图或曲线图是一种将信息显示为由直线段连接的一系列数据点(称为“标记”)的图表。它是许多领域中常见的一种基本图表类型。线图是借助 PyQtGraph 中的绘图类创建的。行的名称用于区分各行。
...
        # getting name of the line 1
        value = line1.name()

        # setting text to the label
        label.setText("Name of Line1 : " + str(value))
...
![](img/0213f11e123690a07cbc096644a0603a.png)