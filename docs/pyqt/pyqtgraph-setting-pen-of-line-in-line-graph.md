...
> 原文:[https://www . geesforgeks . org/pyqtgraph-setting-pen-of-line-in-graph/](https://www.geeksforgeeks.org/pyqtgraph-setting-pen-of-line-in-line-graph/)

在本文中，我们将看到如何在 PyQtGraph 模块的折线图中设置线条的笔。PyQtGraph 是 Python 的图形和用户界面库，提供设计和科学应用程序通常需要的功能。它的主要目标是为显示数据(图表、视频等)提供快速的交互式图形。)折线图、线图、线图或曲线图是一种将信息显示为由直线段连接的一系列数据点(称为“标记”)的图表。它是许多领域中常见的一种基本图表类型。线图是借助 PyQtGraph 中的绘图类创建的。钢笔基本上是画家用来在窗户上画线的对象，借助钢笔我们可以设置线条的颜色。
...
> 为此，我们对行对象
> **使用 setPen 方法语法:** line.setPen(QColor(168，34，3))
> **参数:**它以 QColor/QBrush/QPen 对象作为参数
> **返回:**它返回 None
...
![](img/d35080ef663a9e5543f8eac5e5df7bb4.png)