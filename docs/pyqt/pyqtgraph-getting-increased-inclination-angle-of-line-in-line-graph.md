# PyQtGraph–在线形图中获得增加的线倾角

> 原文:[https://www . geeksforgeeks . org/pyqtgraph-get-增斜-线内倾角-graph/](https://www.geeksforgeeks.org/pyqtgraph-getting-increased-inclination-angle-of-line-in-line-graph/)

在本文中，我们将看到如何在 PyQtGraph 模块中获得增加的线图倾斜角度。PyQtGraph 是 Python 的图形和用户界面库，提供设计和科学应用程序通常需要的功能。它的主要目标是为显示数据(图表、视频等)提供快速的交互式图形。)折线图、线图、线图或曲线图是一种将信息显示为由直线段连接的一系列数据点(称为“标记”)的图表。它是许多领域中常见的一种基本图表类型。线图是借助 PyQtGraph 中的绘图类创建的。倾角是直线与原点相交时形成的角度。可以借助 setRotation 方法进行设置。
...
        # getting increased inclination angle of line 1
        value = line1.rotation()

        # setting text to the label
        label.setText("Increased inclination angle: " + str(value))
...
![](img/6cd02e6e454fce2ca0b4533896ade0d0.png)