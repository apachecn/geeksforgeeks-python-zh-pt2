...
> 原文:[https://www . geeksforgeeks . org/pyqtgraph-设置-不透明度-错误属性-条形图/](https://www.geeksforgeeks.org/pyqtgraph-setting-opacity-property-of-error-bar-graph/)
...
> 为此，我们对错误栏项目对象
> **使用 setOpacity 方法语法:**error . setpacity(n)
> **参数:**它将浮点值作为参数
> **返回:**它返回 None
...
![](img/edd75317e4e13f93a53ac9b211bad47d.png)