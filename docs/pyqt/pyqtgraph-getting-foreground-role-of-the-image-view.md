...
> 原文:[https://www . geeksforgeeks . org/pyqtgraph-get-前台-角色的形象-视图/](https://www.geeksforgeeks.org/pyqtgraph-getting-foreground-role-of-the-image-view/)

下面的文章讨论了如何在 PyQTGaph 中获取图像视图对象的前台角色。在图像视图中基本上有两种类型的角色，一种是前景，另一种是背景。前景角色定义图像视图调色板中用于绘制前景的颜色。
...
为了获取前台角色，我们对图像视图对象使用 foreground role()方法。它不接受参数，并返回一个 QPalette 对象。
**语法:**
...
        # getting foreground role of the image view
        value = imv.foregroundRole()

        # setting text to the label
        label.setText("Foreground Role : " + str(value))
...
![](img/d598500a2fcdce9101bb66ac3bdef99a.png)