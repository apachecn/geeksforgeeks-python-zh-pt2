# PyQtGraph–获得误差条形图的图形效果

> 原文:[https://www . geeksforgeeks . org/pyqtgraph-get-graph-effect-of-error-bar-graph/](https://www.geeksforgeeks.org/pyqtgraph-getting-graphic-effect-of-error-bar-graph/)
...
> 为此，我们将 graphicsEffect 方法与错误栏项对象
> **一起使用语法:**error . graphicsEffect()
> **参数:**它不需要参数
...
        # getting graphic effect of the error bar item
        value = error.graphicsEffect()
...
![](img/712b56d074fb24e11ac8618020d6f6b7.png)