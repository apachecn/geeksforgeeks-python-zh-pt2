# PyQt5 组合框–不可编辑和关闭状态时的不同边框颜色

> 原文:[https://www . geeksforgeeks . org/pyqt 5-combobox-不同-边框-不可编辑时的颜色-关闭状态/](https://www.geeksforgeeks.org/pyqt5-combobox-different-border-color-when-non-editable-and-off-state/)

在本文中，我们将看到当组合框处于不可编辑和关闭状态时，我们如何为它设置不同的边框颜色，当我们为组合框设置边框时，尽管我们可以分别更改每条边的颜色，但它对所有边都是相同的颜色。只有组合框不可编辑且项目视图未打开时，才会出现彩色边框。
...
        # is non-editable and in off state
