# PyQtGraph–设置线图中线条的 Alpha 值

> 原文:[https://www . geeksforgeeks . org/pyqtgraph-setting-alpha-线上线下价值-graph/](https://www.geeksforgeeks.org/pyqtgraph-setting-alpha-value-of-line-in-line-graph/)
...
> 为此，我们对行对象
> **使用 setAlpha 方法语法:** line.setAlpha(n，False)
> **参数:**它以 float(alpha)值和 bool(auto)作为参数
> **Return :** 它返回 None
...
![](img/32d6dbf2b45c7f51917efd2d4eede33c.png)