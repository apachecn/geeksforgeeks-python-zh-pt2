...
> 原文:[https://www . geeksforgeeks . org/python-统计中的均匀分布/](https://www.geeksforgeeks.org/python-uniform-distribution-in-statistics/)

**scipy.stats.uniform()** 是一个 uniform 连续随机变量。它继承自泛型方法的，作为 **rv_continuous 类**的实例。它用特定于这个特定分布的细节来完成这些方法。
...
![](img/175bd0b6290f5d450d9ce33757de422d.png)
...
**输出:**
![](img/1a82dd5d45562491f0714a4d8cabaddf.png)