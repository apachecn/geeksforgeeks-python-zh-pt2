...
> 原文:[https://www . geesforgeks . org/python-截断-指数-统计中的分布/](https://www.geeksforgeeks.org/python-truncated-exponential-distribution-in-statistics/)

**scipy.stats.truncexpon()** 是截断指数连续随机变量。它继承自泛型方法的，作为 **rv_continuous 类**的实例。它用特定于这个特定分布的细节来完成这些方法。
...
![](img/70840eea386d0523983d554cb43f7dc8.png)
...
**输出:**
![](img/625fd27fdfd2fbb1c3d69d7aaea39aee.png)