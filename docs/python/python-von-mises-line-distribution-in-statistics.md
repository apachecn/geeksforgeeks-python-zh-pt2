...
> 原文:[https://www . geesforgeks . org/python-von-mises-line-distribution-in-statistics/](https://www.geeksforgeeks.org/python-von-mises-line-distribution-in-statistics/)

**scipy . stats . vonmises _ line()**是一个 Von Mises 连续随机变量。它继承自泛型方法的，作为 **rv_continuous 类**的实例。它用特定于这个特定分布的细节来完成这些方法。
...
![](img/1c75f37d7cd33582e2e408d780f6aa77.png)
...
![](img/86c657be43d9568f3911ff8981c1cfaa.png)