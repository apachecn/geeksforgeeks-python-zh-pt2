...
> 原文:[https://www . geesforgeks . org/python-skew-normal-distribution-in-statistics/](https://www.geeksforgeeks.org/python-skew-normal-distribution-in-statistics/)

**scipy.stats.skewnorm()** 是一个斜正态连续随机变量。它继承自泛型方法的，作为 **rv_continuous 类**的实例。它用特定于这个特定分布的细节来完成这些方法。
...
![](img/3fb4bc9d64dbd1e5d25a486027d03987.png)
...
**输出:**
![](img/0ab4534f459c9d325d0ddda3161b7ccd.png)