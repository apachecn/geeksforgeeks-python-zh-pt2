...
> 原文:[https://www . geesforgeks . org/python-正态-逆高斯-统计中的分布/](https://www.geeksforgeeks.org/python-normal-inverse-gaussian-distribution-in-statistics/)

**scipy . stats . norminvgauss()**是正态逆高斯连续随机变量。它继承自泛型方法的，作为 **rv_continuous 类**的实例。它用特定于这个特定分布的细节来完成这些方法。
...
![](img/31d16d2bf9f137e1f59faf00eeff3876.png)